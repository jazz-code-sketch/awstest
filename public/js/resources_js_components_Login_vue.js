...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    changeUser: function changeUser(user) {
      _app__WEBPACK_IMPORTED_MODULE_2__.bus.$emit('changeUser', user);
    },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _this.changeUser("Welcome  ".concat(response.data.logged_user.name, "!"));
              ...
              case 9:
                ...
                _this.verify = 'invalid credentials';
                _this.dialog = true;
